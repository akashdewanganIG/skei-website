...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="bg-ivory relative z-20 py-24 sm:py-32 rounded-b-[2rem] sm:rounded-b-[3rem] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.2)]">
          ...
          {FAQS.map((f, i) => {
            ...
            return (
              <div key={f.q}>
                ...
                >
                  <span className={`font-display text-lg sm:text-xl transition-colors duration-200 ${isOpen ? 'text-clay' : 'text-ink group-hover:text-clay'}`}>
                    {f.q}
                  </span>
                  <motion.span
                    ...
                    className={`grid h-8 w-8 shrink-0 place-items-center rounded-full border transition-colors duration-200 ${
                      isOpen
                        ...
                        : "border-line text-ink group-hover:border-clay/50 group-hover:text-clay"
                    }`}
                    aria-hidden
                  >
